...
const initDatabase = async () => {
  try {
    await pool.query(`
      ...
      -- Article Generator Feature - Campaign settings
      CREATE TABLE IF NOT EXISTS article_campaigns (
        ...
        auto_keywords TEXT[],           -- AI-generated keywords from URL analysis
        custom_keywords TEXT[],         -- User-added keywords
        generation_frequency VARCHAR(50) DEFAULT 'manual', -- 'manual', 'daily', 'weekly'
      ...
      -- Article Generator Feature - Generated articles
      CREATE TABLE IF NOT EXISTS generated_articles (
        ...
        -- Generation metadata
        word_count INTEGER,
        generation_provider VARCHAR(50), -- 'openai', 'claude', 'gemini'
        tokens_used INTEGER,
        generation_time_ms INTEGER,
        images_generated INTEGER DEFAULT 0,

        -- Article status
        status VARCHAR(50) DEFAULT 'generated', -- 'generating', 'generated', 'published', 'archived'
        published_url VARCHAR(500),

        -- Image URLs (DALL-E generated)
        hero_image_url TEXT,
        content_images JSONB, -- Array of image URLs

        -- Full generation data for debugging/regeneration
      ...
      -- Article Generator Feature - Usage tracking
